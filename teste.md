...
jo. untuk perbaharui status, flownya di ubah total

1. saat klik tombol perharui status muncul modal
2. di dalam modal ada pilih rentang tanggal dalam periode (dari tabel pay_period) dan search dan checklist karyawan.
3. kemudian klik tombol perbaharui status.
4. prosesnya :
...
cek bila ada conflik dengan perhitungan sekarang, dan sampaikan kepada saya

jo di /admin/payroll/gaji-karyawan tombol finalisasi. untuk mendapatkan absent seperti di bawah.
absent = count status='absent' + missing
...
di /admin/payroll/gaji-karyawan pada tombol export excel, di kolom masa kerja itu hitungannya seperti apa ?

hitungan yang sekarang benar, tapi untuk kondisi kedua.
