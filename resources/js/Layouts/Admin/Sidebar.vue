...
const allMenus = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Penggajian', icon: 'bx bx-time', route: '/admin/payroll' },
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Dokumen', icon: 'bx bx-folder', route: '/admin/employees' },
      { title: 'Resign & PHK', icon: 'bx bx-exit', route: '/admin/employees' },
    ],
  },
  {
    title: 'Jadwal Kerja',
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Periode Payroll', icon: 'bx bx-calendar-edit', route: '/admin/payroll' },
