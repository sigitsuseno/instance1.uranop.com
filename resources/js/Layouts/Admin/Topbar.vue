      ...
      <Dropdown position="right" width="w-64" :closeOnClickOutside="true">
        ...
        <template #content="{ close }">
          <div @click.stop>
            ...
            <router-link to="/admin/settings" @click.stop="close" class="flex items-center px-4 py-2 text-sm text-(--text-main) hover:bg-(--bg-elevated) transition-colors">
