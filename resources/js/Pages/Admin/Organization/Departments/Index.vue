    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-sm text-(--text-muted) mt-1">Kelola struktur organisasi dan departemen perusahaan</p>
        </div>
      </div>
      ...
      <form @submit.prevent="handleSave">
        ...
        <div class="flex items-start gap-4 mb-6 p-4 rounded-xl bg-(--bg-elevated)/50 border border-(--border-soft)">
          ...
          <div>
            ...
            <p class="text-xs text-(--text-muted) mt-1">Pastikan kode departemen unik dan mudah diidentifikasi untuk keperluan laporan.</p>
          </div>
        </div>
