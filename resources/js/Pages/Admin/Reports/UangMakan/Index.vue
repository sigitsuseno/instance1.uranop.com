<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      <div>
        <h1 class="text-xl font-semibold text-(--text-main)">Laporan Uang Makan</h1>
        <p class="text-sm text-(--text-muted) mt-1">Rekapitulasi uang makan karyawan — harian & bulanan</p>
      </div>
    </div>
...
onMounted(async () => {
  try {
    ...
    // Default: JKT, ALLIN, GD, SPR checked (PS1 & SS unchecked)
