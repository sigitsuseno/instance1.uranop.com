            ...
            <table class="w-full text-xs">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="border border-(--border-soft) px-2 py-2 text-center text-(--text-muted)">{{ record.lm > 0 ? (record.lm / 480).toFixed(1).replace('.', ',') : '-' }}</td>
                  <td class="border border-(--border-soft) px-2 py-2 text-center text-(--text-muted)">{{ record.lembur_count > 0 ? (record.lembur_count / 60).toFixed(1).replace('.', ',') + 'j' : '-' }}</td>
              ...
              <tfoot v-if="section.data.length > 0">
                <tr class="bg-(--bg-elevated) font-bold text-(--text-main) border-t-2 border-(--border-soft)">
                  ...
                  <td class="border border-(--border-soft) px-2 py-3.5 text-center text-(--text-muted)">{{ section.totals.lm > 0 ? (section.totals.lm / 480).toFixed(1).replace('.', ',') : '-' }}</td>
                  <td class="border border-(--border-soft) px-2 py-3.5 text-center text-(--text-muted)">{{ section.totals.lembur_count > 0 ? (section.totals.lembur_count / 60).toFixed(1).replace('.', ',') + 'j' : '-' }}</td>
