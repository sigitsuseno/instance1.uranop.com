...
async function uploadFile() {
  ...
  try {
    const res = await post('/api/v1/supervisor/employee-data/salaries/import', formData, {
      headers: {
...
<template>
  <div class="space-y-6 max-w-4xl">
    <div class="flex items-center justify-between">
      ...
      <BaseButton variant="primary" @click="$router.push('/supervisor/employee-data/gaji-karyawan')">
