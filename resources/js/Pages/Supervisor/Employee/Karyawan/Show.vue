...
async function fetchSalaryComponents() {
  try {
    const res = await get(`/api/v1/supervisor/employee-data/karyawan/${employeeId.value}/salary-components`)
  ...
  <div class="space-y-6">
    ...
    <template v-else-if="employee">
      <div class="flex items-center justify-between">
        ...
        <BaseButton variant="primary" @click="$router.push(`/supervisor/employee-data/karyawan/${employeeId}/edit`)">
          <template #icon-left>
