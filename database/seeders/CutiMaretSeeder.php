...
class CutiMaretSeeder extends Seeder
{
    protected $csvFile = 'cuti_maret.csv';
    ...
    {
        echo "\n=== MEMPROSES SEEDER REKAP CUTI MARET 2026 ===\n";
    ...
    protected function findCsvFile()
    {
        $paths = [
            ...
            database_path('seeders/REKAP CUTI BULAN MARET 2026.csv'),
            base_path('REKAP CUTI BULAN MARET 2026.csv'),
        ];
    ...
    protected function createOrUpdateLeaveRequest($employeeId, $leaveTypeId, $date, $leaveCode): void
    {
        ...
        $leaveRequest = LeaveRequest::updateOrCreate(
            ...
            [
                ...
                'days_requested' => 1,
                'reason' => 'Auto-generated from March 2026 recap',
                'status' => $status,
                'created_by' => 1,
            ]
        );
        ...
        if ($isNew && $leaveType && $leaveType->balance_type === 'decrement') {
            EmployeeLeave::create([
                ...
                'amount' => 1,
                'description' => 'Auto-generated from March 2026 recap',
                'created_by' => 1,
            ]);
        }
