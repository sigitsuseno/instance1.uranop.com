...
Route::prefix('v1/supervisor')
    ...
    ->group(function () {
        ...
        Route::prefix('attendance')->group(function () {
            ...
            Route::get('roster', [\App\Modules\Supervisor\Attendance\Controllers\AttendanceAutologController::class, 'roster'])->middleware('role:superadmin');
            ...
            Route::post('absensi/export-selected', [\App\Modules\Supervisor\Attendance\Controllers\AttendanceAutologController::class, 'exportSelected']);
