...
class SupervisorLeaveSettingController extends Controller
{
    // --- Leave Types ---
    ...
    public function storeType(Request $request)
    {
        ...
        return response()->json(['message' => 'Leave type created (Supervisor)', 'data' => $type], 201);
    }
    ...
    public function updateType(Request $request, $id)
    {
        ...
        return response()->json(['message' => 'Leave type updated (Supervisor)', 'data' => $type]);
    }

    public function destroyType($id)
    {
        LeaveType::findOrFail($id)->delete();
        return response()->json(['message' => 'Leave type deleted (Supervisor)']);
    }
    ...
    public function storePolicy(Request $request)
    {
        ...
        return response()->json(['message' => 'Leave policy created (Supervisor)', 'data' => $policy], 201);
    }
    ...
    public function updatePolicy(Request $request, $id)
    {
        ...
        return response()->json(['message' => 'Leave policy updated (Supervisor)', 'data' => $policy]);
    }

    public function destroyPolicy($id)
    {
        LeavePolicy::findOrFail($id)->delete();
        return response()->json(['message' => 'Leave policy deleted (Supervisor)']);
    }
    ...
    public function storePeriod(Request $request)
    {
        ...
        return response()->json(['message' => 'Leave period created (Supervisor)', 'data' => $period], 201);
    }
    ...
    public function updatePeriod(Request $request, $id)
    {
        ...
        return response()->json(['message' => 'Leave period updated (Supervisor)', 'data' => $period]);
    }

    public function destroyPeriod($id)
    {
        LeavePeriod::findOrFail($id)->delete();
        return response()->json(['message' => 'Leave period deleted (Supervisor)']);
    }
}
