...
class LemburBulananExport implements FromArray, WithHeadings, WithMapping, WithStyles, WithColumnWidths, WithEvents
{
    protected $data;
    protected $dates;
    protected $label;
    ...
    public function headings(): array
    {
        ...
        $row1 = ['LAPORAN LEMBUR BULANAN — ' . strtoupper($this->label)];
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function (AfterSheet $event) use ($totalCols, $lastCol, $dataStartRow, $lastRow) {
                ...
                $col = self::FIXED_COLS + 1; // 1-based, first date col = I (9)
                foreach ($this->dates as $dateStr) {
