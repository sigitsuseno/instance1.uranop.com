...
class UangMakanBulananExport implements FromArray, WithHeadings, WithMapping, WithStyles, WithColumnWidths, WithEvents
{
    protected $data;
    protected $dates;
    protected $label;
    ...
    public function headings(): array
    {
        ...
        $row1 = ['LAPORAN UANG MAKAN — ' . strtoupper($this->label)];
        $row2 = [''];
